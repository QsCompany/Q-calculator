...
export declare var Fields_Names: string[];
export declare enum EFields {
    about = "about",
    id = "id",
    address = "address",
...
export declare var Edges_fields: string[];
