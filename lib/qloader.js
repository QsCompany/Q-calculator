...
(function (window) {
    ...
    $defineProperty(window, '__extends', { get: function () { return __extends1; }, set: function () { }, configurable: false, enumerable: false }, function () { __extends = __extends1; });
...
(function (System) {
    ...
    (function (net) {
        ...
        var WebRequest = (function () {
            ...
            WebRequest.prototype._onprogress = function (_e) {
        ...
        var Downloader = (function () {
            ...
            Downloader.prototype.DownloadComplete = function (_xmlRequest) {
                var x;
                this.isDownloading = false;
    ...
    (function (core) {
        ...
        var Module = (function () {
            ...
            Module.prototype.onGStatChanged = function (_old, _new) {
                ...
                try {
                    ...
                    try {
                        if (_listeners_1_1 && !_listeners_1_1.done && (_b = _listeners_1.return)) _b.call(_listeners_1);
                    }
                ...
                if (app != undefined) {
                    ...
                    if (url.IsPlugin) {
                        if (app.indexOf('lib:') === 0) {
                            ...
                            lib.OnExecuted = function (ass, _e) {
                                if (ass.EntryPoint) {
                                    lib.EntryPoint.OnExecuted = function (m, _e) {
                                        var o = m.exports;
                                        if (m.Stat === 6)
                                            o.Start && o.Start();
                                        else
        ...
        var Assembly = (function (_super) {
            ...
            Assembly.prototype.OnEntryPointExecuted = function (_m, _e) {
            ...
            Assembly.prototype.onModuleExecuted = function (_m, _e) {
                this.pending--;
                if (this.pending == 0)
                    this.OnAssemblyExecuted();
            };
            ...
            Assembly.prototype.OnAssemblyDependencyExecuted = function (_m, _e) {
            ...
            Assembly.prototype.loadLibs = function (m, dependencies, _callback) {
                for (var i = 0, l = dependencies.length; i < l; i++) {
                    ...
                    if (d.indexOf('lib:') == 0) {
                        ...
                        if (path.indexOf('*') == 0)
                            path = path.substr(1);
                        this.LoadAssembly(m.Folder, path, alias);
                    }
                }
            };
        ...
        var Args = (function () {
            ...
            Args.prototype.onAssemblyExecuted = function (_assembly, _e) {
                this.nsuccess++;
                this.checkNSuccess();
            };
            Args.prototype.onModuleExecuted = function (_module) {
                this.nsuccess++;
                this.checkNSuccess();
            };
            ...
            Args.prototype.getUnExecuted = function () {
                var t = [];
                this.Dependencies.forEach(function (v, _i, _a) { if (v.module instanceof Module)
                    if (v.module.Stat < 6)
            ...
            Args.prototype.getUnSuccessed = function () {
                var t = [];
                this.Dependencies.forEach(function (v, _i, _a) {
        ...
        var managers;
        (function (managers) {
            $defineProperty(window, 'define', { get: function () { return CodeManager.define; }, set: function (_v) { }, configurable: false, enumerable: false });
            $defineProperty(window, 'require', { get: function () { return CodeManager._current && CodeManager._current.module.require || root.require; }, set: function (_v) { }, configurable: false, enumerable: false });
            var Plugins = (function () {
                function Plugins() {
                    this._eventsStore = {};
                }
                Plugins.prototype.Define = function (_e) { };
                Plugins.prototype.Execute = function (_e) { };
            ...
            var CodeManager = (function (_super) {
                ...
                CodeManager.prototype.Define = function (_e) {
                };
                CodeManager.prototype.Execute = function (_e) {
                };
                ...
                CodeManager.loadDependencies = function (m, dependencies, callback) {
                    ...
                    for (var i = 0, l = dependencies.length; i < l; i++) {
                        var d = dependencies[i];
                        var _b = Module.__require(m, d), mdl = _b.mdl, isOptional = _b.isOptional;
            ...
            var StyleManager = (function (_super) {
                ...
                StyleManager.prototype.Define = function (_e) {
                };
                StyleManager.prototype.Execute = function (_e) {
                };
            ...
            var TemplateManager = (function (_super) {
                ...
                TemplateManager._execute = function (http, pr) {
                    ...
                    if (pr.IsSuccess && requires.length != 0) {
                        CodeManager.asyncLoadDependencies(m, requires, function () {
                ...
                TemplateManager.prototype.Execute = function () {
                };
    ...
    function getUExecuted() {
        ...
        var ts = [];
        var t = [];
        getUnExecuted().forEach(function (v) {
            var tx = getM(v.m);
            v.r.forEach(function (av) {
                getM(av).push(tx);
            });
        }, t);
        return ts;
