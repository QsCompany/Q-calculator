...
define(["require", "exports", "../../component", "../../../../lib/q/sys/Dom"], function (require, exports, component_1, Dom_1) {
    "use strict";
    ...
    var cardHeaderText = (function (_super) {
        ...
        cardHeaderText._builder = function (e) {
            e.node.e.Control = new cardHeaderText(e.node.Dom);
        };
        ...
        __decorate([
            Dom_1.attributes.ComponentHandler("md-card-header-text", component_1.templateWrapper({ templateName: "md-card-header-text" })),
