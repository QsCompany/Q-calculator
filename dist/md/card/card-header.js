...
define(["require", "exports", "../../../lib/q/sys/Dom", "../component", "../../../lib/q/Core"], function (require, exports, Dom_1, component_1, Core_1) {
    ...
    var cardHeader = (function (_super) {
        ...
        cardHeader._builder = function (e) {
            e.node.e.Control = new cardHeader(e.node.Dom).reset();
        };
        cardHeader.prototype.addComponent = function (e) { this.Add(e.child.Dom); };
        cardHeader.prototype.initialize = function () { this.applyStyle("md-card-header"); };
        cardHeader.prototype.Add = function (child) { return _super.prototype.Add.call(this, child instanceof Node ? new Core_1.UI.Dom(child) : child); };
        __decorate([
            Dom_1.attributes.ContentHandler(true),
            __metadata("design:type", Function),
            __metadata("design:paramtypes", [Object]),
            __metadata("design:returntype", void 0)
        ], cardHeader.prototype, "addComponent", null);
        __decorate([
            Dom_1.attributes.ComponentHandler("card-header"),
            __metadata("design:type", Function),
            __metadata("design:paramtypes", [Object]),
            __metadata("design:returntype", void 0)
        ], cardHeader, "_builder", null);
        return cardHeader;
